...
- **Equipe** — Apresentação dos membros e suas funções
- **Jogos** — Seção dedicada ao jogo *A Última Luz*, com trailer
- **Parceiros** — Logos e referências às empresas parceiras
...
| Nome | Função |
|---|---|
| Susana Correia Garcia | Level Designer, UI/UX Designer |
| Kauan de Carlo Merida | Game Developer, Level Designer |
| Felipe Musatto Rodrigues | Concept Artist, 3D Modeler |
| Hudson Araujo Barreiro | Web Developer, Game Developer |
| Pedro Santos Menezes | Web Developer, Game Developer |
| Vitória Colussi dos Santos | Level Designer, Designer de Som |
